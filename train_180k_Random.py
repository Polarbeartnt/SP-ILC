...
if __name__ == "__main__":
    ...
    gen = GenerateInput(Batch_size, lines[:num_train], indexs[:num_train], M, image_size_lab).generate()
    gen_val = GenerateInput(Batch_size, lines[num_train:], indexs[num_train:], M, image_size_lab).generate()
