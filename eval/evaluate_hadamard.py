...
predictor = Predictor(_defaults = {
            "model_path"        : 'logs/排序Hadamard/Epoch40-Total_Loss18.6543-Val_Loss19.2958.pth',#path of your weights-file
...
for path in Path:
    ...
    for p in exfile:
        ...
        pr = Precision_Recall('test_results/'+path+'_bbox/'+name, p.replace('Objects', 'Objects_label').replace('Object/', 'Object_label/'),confbar=[x/20 + 0.05 for x in range(20)])
