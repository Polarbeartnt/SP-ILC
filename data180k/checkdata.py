...
def TestDataSet(filepath='expdata/Multiple_Objects_fig'):
    ...
    if not os.path.exists('expdata/labeltest'):
        os.mkdir('expdata/labeltest')
    ...
    for filename in imagenames:
        ...
        cv2.imwrite('expdata/labeltest/{}.png'.format(filename), image)
